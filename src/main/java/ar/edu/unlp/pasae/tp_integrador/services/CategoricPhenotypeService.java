...
public interface CategoricPhenotypeService {
	...
	/**
	 * Devuelve un Paginado de fenotipos, de acuerdo a los parametros dados
	 ...
	 */
	CategoricPhenotypeDTO update(Long phenotypeId, CategoricPhenotypeDTO phenotype);
