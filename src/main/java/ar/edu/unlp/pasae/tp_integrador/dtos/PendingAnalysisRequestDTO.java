...
public class PendingAnalysisRequestDTO {
	@NotEmpty
	...
	public PendingAnalysisRequestDTO(String description, Set<Long> patientsIds, String phenotypeKind, Long phenotypeId, String snps) {
		super();
	...
	public PendingAnalysisRequestDTO(String description, Set<Long> patientsIds, String phenotypeKind, Long phenotypeId, String snps, Long cutoffValue) {
		this(description, patientsIds, phenotypeKind, phenotypeId, snps);
		this.setCutoffValue(cutoffValue);
	}

	public PendingAnalysisRequestDTO() {
		super();
	}
